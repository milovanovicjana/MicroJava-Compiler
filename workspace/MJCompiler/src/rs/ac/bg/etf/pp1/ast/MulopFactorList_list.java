...
public class MulopFactorList_list extends MulopFactorList {

    private MulopFactorList MulopFactorList;
    private Mulop Mulop;
    private Factor Factor;

    public MulopFactorList_list (MulopFactorList MulopFactorList, Mulop Mulop, Factor Factor) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MulopFactorList_list(\n");
