...
public class ConditionTermList_or extends ConditionTermList {

    private ConditionTermList ConditionTermList;
    private ConditionTerm ConditionTerm;

    public ConditionTermList_or (ConditionTermList ConditionTermList, ConditionTerm ConditionTerm) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConditionTermList_or(\n");
