...
public class ConditionFactList_and extends ConditionFactList {

    private ConditionFactList ConditionFactList;
    private ConditionFact ConditionFact;

    public ConditionFactList_and (ConditionFactList ConditionFactList, ConditionFact ConditionFact) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConditionFactList_and(\n");
