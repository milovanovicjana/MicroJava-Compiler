...
public class FactorSub_designator2 extends FactorSub {

    private FunCallName FunCallName;
    private ActParsList ActParsList;

    public FactorSub_designator2 (FunCallName FunCallName, ActParsList ActParsList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FactorSub_designator2(\n");
